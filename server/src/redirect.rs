...
///
/// let route = nextshell::path("v1")
///     .map(|| {
///         nextshell::redirect(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = nextshell::path("v1")
///     .map(|| {
///         nextshell::redirect::found(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = nextshell::path("v1")
///     .map(|| {
///         nextshell::redirect::see_other(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = nextshell::path("v1")
///     .map(|| {
///         nextshell::redirect::temporary(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = nextshell::path("v1")
///     .map(|| {
///         nextshell::redirect::permanent(Uri::from_static("/v2"))
///     });
/// ```
...
mod sealed {
    ...
    /// arguments could be accepted, like maybe just `nextshell::redirect("/v2")`.
