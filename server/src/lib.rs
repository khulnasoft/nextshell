...
//! # nextshell
//!
//! nextshell is a super-easy, composable, web server framework for nextshell speeds.
//!
//! Thanks to its [`Filter`][Filter] system, nextshell provides these out of the box:
//!
...
//! ## Filters
//!
//! The main concept in nextshell is the [`Filter`][Filter], which allows composition
//! to describe various endpoints in your web service. Besides this powerful
//! trait, nextshell comes with several built in [filters](filters/index.html), which
...
//!
//! let hi = nextshell::path("hello")
//!     .and(nextshell::path::param())
//!     .and(nextshell::header("user-agent"))
...
//! ## Testing
//!
//! Testing your web services easily is extremely important, and nextshell provides
