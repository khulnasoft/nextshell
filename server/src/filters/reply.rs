...
//!
//! let with_server = nextshell::reply::with::header("server", "nextshell");
//!
...
/// let route = nextshell::any()
///     .map(nextshell::reply)
///     .with(nextshell::reply::with::header("foo", "bar"));
/// ```
...
/// let route = nextshell::any()
///     .map(nextshell::reply)
///     .with(nextshell::reply::with::headers(headers));
/// ```
...
/// use nextshell::Filter;
///
/// // Set `server: nextshell` if not already set.
/// let route = nextshell::any()
///     .map(nextshell::reply)
///     .with(nextshell::reply::with::default_header("server", "nextshell"));
/// ```
