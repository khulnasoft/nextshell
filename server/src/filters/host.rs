...
///
/// let multihost =
///     nextshell::host::exact("foo.com").map(|| "you've reached foo.com")
///     .or(nextshell::host::exact("bar.com").map(|| "you've reached bar.com"));
/// ```
...
///
/// ```
/// use nextshell::{Filter, host::Authority};
///
/// let host = nextshell::host::optional()
